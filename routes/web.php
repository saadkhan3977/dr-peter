...
Route::get('ProductDetails/{id}', [FrontendController::class, 'ProductDetails'])->name('product-details');
...
Route::post('OrderProduct', [CartController::class, 'store']);
...
Route::group(['prefix'=>'admin','middleware'=>['auth','admin']],function(){
    ...
    Route::get('/dahsboard',[\App\Http\Controllers\AdminController::class,'index'])->name('admin.dashboard');
