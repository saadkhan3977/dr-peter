                ...
                <div class="row g-5">
                    <div class="col-md-12 col-lg-6 col-xl-7">
                        ...
                        <div class="form-item">
                            ...
                            <input type="text" value="cod" class="form-control" name="payment_method"
                                readonly>
                        </div>
                        <hr>
                    </div>
                    <div class="col-md-12 col-lg-6 col-xl-5">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    {{-- <input type="text" value="{{ $cart }}" name="products[]" readonly> --}}
                                    @foreach ($cart as $item)
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center mt-2">
                                                    <img src="{{ $item->products->photo }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-5">
                                            <div class="py-3 border-bottom border-top">
                                                ...
                                                <input type="number" hidden name="total_amount"
                                                    value="{{ $total }}">
                                            </div>
                                        </td>
                                    </tr>
